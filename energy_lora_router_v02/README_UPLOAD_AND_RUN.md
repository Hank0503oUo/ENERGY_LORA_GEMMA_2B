...
- `tools\harness_v02\harness_v02_manifest.json` 裡 `profile` 是 `router_strict`
...
| 檔案 | 筆數 | 用途 |
|------|------|------|
| `harness_v02_train.jsonl` | 297 | LoRA 訓練 |
| `harness_v02_val.jsonl` | 38 | 固定驗證 |
| `harness_v02_smoke.jsonl` | 4 | 快速檢查 |
