"""Convert dispatch JSONL -> chat messages JSONL for LoRA training.
...
cfg_path = _here / "00_config_v09.py"
if not cfg_path.exists():
    cfg_path = Path("/content/drive/MyDrive/energy_lora_router_v09/scripts/00_config_v09.py")
spec = importlib.util.spec_from_file_location("v09cfg", cfg_path)
