"""v04 stratified dataset splitter.
...
Usage:
    python split_dataset.py /path/to/merged_v04_all.jsonl --output-dir /path/to/data/processed/
    python split_dataset.py /path/to/merged_v04_all.jsonl --output-dir ... --val-ratio 0.12 --val-min 300
"""
...
def build_manifest(
    ...
    manifest_path = output_dir / "harness_v04_manifest.json"
...
def main():
    parser = argparse.ArgumentParser(description="Split v04 dataset into train/val/smoke")
    ...
    out = args.output_dir
    train_path = out / "train_v04.jsonl"
    val_path = out / "val_v04.jsonl"
    smoke_path = out / "smoke_v04.jsonl"
    ...
    merged_path = out / "merged_v04_all.jsonl"
