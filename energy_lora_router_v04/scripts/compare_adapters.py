"""v04 multi-adapter comparison tool.
...
Usage:
    python compare_adapters.py \
        ...
        --val-file data/processed/val_v04.jsonl \
        --smoke-file data/processed/smoke_v04.jsonl
"""
...
def main():
    parser = argparse.ArgumentParser(description="Compare multiple v04 router adapters")
