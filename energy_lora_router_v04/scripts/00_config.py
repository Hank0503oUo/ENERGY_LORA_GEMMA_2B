"""Shared config for harness router-strict LoRA data pipeline (v04 edition).
...
This is a copy of v04/scripts/00_config.py with paths re-pointed at v04.
Tool catalogue + BOUNDARY_RULES are kept identical to v04 so transferring
v04 training data into v04 doesn't shift the system prompt.
...
DRIVE_ROOT = Path("/content/drive/MyDrive/energy_lora_router_v04")
