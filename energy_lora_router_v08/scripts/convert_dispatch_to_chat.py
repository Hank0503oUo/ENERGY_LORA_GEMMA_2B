"""Convert V06 dispatch JSONL -> chat messages JSONL for LoRA training.
...
cfg_path = _here / "00_config_v08.py"
if not cfg_path.exists():
    cfg_path = Path(r"G:\我的雲端硬碟\energy_lora_router_v08\scripts\00_config_v08.py")
spec = importlib.util.spec_from_file_location("v08cfg", cfg_path)
