"""v05 stratified dataset splitter.
...
Usage:
    python split_dataset.py /path/to/merged_v05_all.jsonl --output-dir /path/to/data/processed/
    python split_dataset.py /path/to/merged_v05_all.jsonl --output-dir ... --val-ratio 0.12 --val-min 300
"""
...
def build_manifest(
    ...
    manifest_path = output_dir / "harness_v05_manifest.json"
...
def main():
    parser = argparse.ArgumentParser(description="Split v05 dataset into train/val/smoke")
    ...
    out = args.output_dir
    train_path = out / "train_v05.jsonl"
    val_path = out / "val_v05.jsonl"
    smoke_path = out / "smoke_v05.jsonl"
    ...
    merged_path = out / "merged_v05_all.jsonl"
