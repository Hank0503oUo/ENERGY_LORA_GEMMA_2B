"""v05 multi-adapter comparison tool.
...
Usage:
    python compare_adapters.py \
        ...
        --val-file data/processed/val_v05.jsonl \
        --smoke-file data/processed/smoke_v05.jsonl
"""
...
def main():
    parser = argparse.ArgumentParser(description="Compare multiple v05 router adapters")
