"""v06 router evaluator — dispatch contract recovery round.
...
OUTPUT_DIR = DRIVE_PROJECT_DIR / "outputs" / "gemma_dispatch_v06" / "eval"
...
def check_gates(report: dict[str, Any]) -> dict[str, bool]:
    """Check v06 eval gates. Returns gate_name -> passed bool."""
    if report.get("schema_mode") == "dispatch":
        by_diff = report.get("by_difficulty", {})
        by_dispatch = report.get("by_expected_dispatch_type", {}) or report.get("by_expected_tool", {})
...
def main():
    ...
    parser.add_argument("--prefix", type=str, default="v06", help="Output file prefix")
